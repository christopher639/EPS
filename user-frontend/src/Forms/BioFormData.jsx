...
const BioFormData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Biology mark saved successfully!");
      setIsSubmitted(true);
      setFormData({
        subjectcode: "bio10",
        regno: "",
      ...
      // Reset submission button state after 2 seconds
      setTimeout(() => {
  ...
  // Handle delete action (if needed in the future)
            ...
            <table className='min-w-full'>
              <thead className='bg-slate-800 text-white'>
                <tr>
                  ...
                  <th className='border-r whitespace-nowrap'>BIOLOGY SCORE</th>
              ...
              <tbody>
                {students.map((student, index) => (
                  <tr key={index} className='border py-3 border-slate-500'>
                    ...
                    <td className='pr-2 text-center border border-slate-500'>{student.marks.bio10}</td>
