...
const PhycFormData = () => {
 ...
 <div className='flex  mx-2   flex-col max-h-[70vh] sm:max-h-[50vh]  overflow-y-auto overflow-x-auto'>
      ...
      <table className='min-w-full'>
        <thead className='bg-slate-800 text-white '>
          <tr>
            ...
            <th className='border-r whitespace-nowrap'>PHYSC SCORE</th>
