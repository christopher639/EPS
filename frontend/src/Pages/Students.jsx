    ...
    <div className='flex flex-col min-w-full'>
           ...
           <div className='flex  max-h-[77vh] overflow-y-auto overflow-x-auto mr-5 md:mr-0   '>
             <table className=' min-w-full   mt-2'>
               ...
               <th  className='border whitespace-nowrap  px-1 px-2'>NO</th>
               ...
               <tbody>
                 {
                   students.map((student,index) =>{
                     return(
                       <tr key={index} className='border  h-10  py-3 border-slate-500'>
                         ...
                         <td  className='pr-2 whitespace-nowrap  border border-slate-500'>{student.dot}</td>
                         <td  className='pr-2 whitespace-nowrap border border-slate-500'>{student.stream}</td>
                         
                         <td className=' border whitespace-nowrap  border-slate-500 text-center'><button className=' text-white px-1 rounded-sm curser-pointer '>
