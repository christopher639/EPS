  ...
  return (
    <div className="hidden min-h-full   insert-y-0 left-0   transform -translate-x-full  transition-transform duration-300 md:relative md:translate-x-0       md:flex flex-col min-h-full  min-w-full ">
      ...
      <NavLink to="/admission">
        <div className="flex border-b w-full px-3 hover:bg-gray-800 hover:text-white py-1 felx-row gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <NavLink to="/fees">
        <div className="flex border-b w-full px-3 hover:bg-gray-800 hover:text-white py-1 felx-row gap-2">
          ...
          <li className="list-none">BALANCES</li>
        </div>
      </NavLink>
      ...
      <NavLink to="/parents">
        <div className="flex border-b w-full px-3 hover:bg-gray-800 hover:text-white  py-1 felx-row gap-2">
          ...
          <li className="list-none">PARENTS</li>
        </div>
      </NavLink>
      ...
      <NavLink to="/users">
        <div className="flex border-b hover:bg-gray-800 hover:text-white w-full px-3 py-1 felx-row gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <div className="  w-full flex hover:bg-gray-800 hover:text-white px-3 py-1 flex-row  ">
        <div className="list-none  flex  mt-2 justify-center items-center  h-[40px]">
          <img
            className="w-8 border rounded-full h-8"
            src="profileimg.jpg"
            alt="Description of image"
          />
        </div>
