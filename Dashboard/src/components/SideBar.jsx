...
const SideBar = ({ isSidebarCollapsed, toggleSidebar }) => {
  ...
  const [isUploadMarksModalOpen, setIsUploadMarksModalOpen] = useState(false);
  ...
  const openUploadMarksModal = () => setIsUploadMarksModalOpen(true);
  const closeUploadMarksModal = () => setIsUploadMarksModalOpen(false);
  ...
  return (
    <>
      ...
      {/* Upload Marks Modal */}
      <UploadMarksModal isOpen={isUploadMarksModalOpen} onClose={closeUploadMarksModal} />
    </>
  );
};
