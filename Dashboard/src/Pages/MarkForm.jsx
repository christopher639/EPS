    ...
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50  flex items-center justify-center p-4 z-50">
      ...
      {/* Main Content */}
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          {/* Form Header */}
          <div className="bg-gradient-to-r  flex justify-between from-blue-600 to-blue-800 px-6 py-4">
            <h2 className="text-xl font-semibold text-white">Enter Leaner Marks</h2>
            <button 
            onClick={onClose}
            className="p-2 text-white hover:bg-blue-700 rounded-full transition-colors duration-200"
          >
