...
const AddMarks = () => {
  ...
  return (
<div className="mx-auto overflow-y-auto max-h-screen">
<div className="flex justify-between items-center ">
         <h1 className="font-bold    ml-5  text-gray-800">Sagme</h1>
         <UserAccount />
       </div>
<div className="flex justify-center">
   <div className="min-h-screen bg-gray-100 flex">
     <div className="flex-1 px-6 ">
       ...
       <div className="bg-white max-w-[500px] rounded-lg shadow-md pb-24 p-6">
